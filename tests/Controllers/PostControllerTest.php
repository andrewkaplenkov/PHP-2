...
class PostControllerTest extends TestCase
{
	...
	public function testItFindsPostById(): void
	{
		...
		$post = $postController->getPostById(new UUID('9b43495f-7f31-4ed5-9b8c-94dbbf9a5ae7'));

		$this->assertSame('9b43495f-7f31-4ed5-9b8c-94dbbf9a5ae7', (string)$post->id());
	}
	...
	public function testItThrowsAnExceptionWhenPostNotFound(): void
	{
		...
		$postController->getPostById(new UUID('9b43495f-7f31-4ed5-9b8c-94dbbf9a5ae7'));
	}
}
