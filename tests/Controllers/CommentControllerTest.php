...
class CommentControllerTest extends TestCase
{
	...
	public function testItThrowsAnExceptionWhenCommentNotFound(): void
	{
		...
		$commentController->getCommentById(new UUID('d74cf51b-f782-4fd1-8f9b-d66114cabb31'));
	}
	...
	public function testItFindsCommentById(): void
	{
		...
		$comment = $commentController->getCommentById(new UUID('9b43495f-7f31-4ed5-9b8c-94dbbf9a5ae7'));

		$this->assertSame('9b43495f-7f31-4ed5-9b8c-94dbbf9a5ae7', (string)$comment->id());
	}
}
